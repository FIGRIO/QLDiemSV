...
-- =============================================================
-- THÊM DỮ LIỆU MẪU (Để test code C# không bị lỗi null)
-- =============================================================
...
('D21CN1', N'CNTT K21 - Lớp 1', 'CNTT'),
('D21KT1', N'Kinh tế K21 - Lớp 1', 'KT');
...
('LTC', N'Lập trình C#', 4),
('JAVA', N'Lập trình Java', 4);

-- 5. Giảng viên
INSERT INTO GiangVien (MaGV, HoTen, Email, SDT, MaKhoa) VALUES 
('GV01', N'Nguyễn Văn A', 'a@gmail.com', '0901111111', 'CNTT'),
('GV02', N'Trần Thị B', 'b@gmail.com', '0902222222', 'KT');

-- 6. Sinh viên
INSERT INTO SinhVien (MSSV, HoTen, NgaySinh, GioiTinh, Email, SDT, DiaChi, MaLop) VALUES 
('SV001', N'Lê Văn C', '2003-05-10', N'Nam', 'c@gmail.com', '0988888888', N'Hà Nội', 'D21CN1'),
('SV002', N'Phạm Thị D', '2003-08-20', N'Nữ', 'd@gmail.com', '0977777777', N'Hà Nam', 'D21CN1');

-- 7. Lớp học phần
INSERT INTO LopHocPhan (MaLHP, MaMon, MaGV, HocKy, NamHoc, TyLeQT, TyLeCK, Thu, TietBD, SoTiet, Phong) 
VALUES 
('LHP001', 'CSDL', 'GV01', '1', '2024-2025', 0.3, 0.7, 2, 1, 3, 'A1-101'),
('LHP002', 'LTC', 'GV01', '1', '2024-2025', 0.4, 0.6, 4, 7, 3, 'A2-202');

-- 8. Kết quả
INSERT INTO KetQua (MaLHP, MSSV, DiemGK, DiemCK, DiemTK, DiemChu) 
VALUES 
('LHP001', 'SV001', 8.0, 9.0, 8.7, 'A'),
('LHP001', 'SV002', 7.0, 6.0, 6.3, 'C');
