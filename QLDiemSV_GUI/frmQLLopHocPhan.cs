...
namespace QLDiemSV_GUI
{
    public partial class frmQLLopHocPhan : Form
    {
        ...
        {
            cboMonHoc.DataSource = busMH.GetDS(); cboMonHoc.DisplayMember = "TenMon"; cboMonHoc.ValueMember = "MaMon";
