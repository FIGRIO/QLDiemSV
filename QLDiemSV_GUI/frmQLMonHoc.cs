...
namespace QLDiemSV_GUI
{
    public partial class frmQLMonHoc : Form
    {
        ...
        private void DgvMonHoc_CellClick(object sender, DataGridViewCellEventArgs e) { if (e.RowIndex >= 0) { var r = dgvMonHoc.Rows[e.RowIndex]; txtMaMH.Text = r.Cells["MaMon"].Value.ToString(); txtMaMH.Enabled = false; txtTenMH.Text = r.Cells["TenMon"].Value.ToString(); numTinChi.Value = Convert.ToDecimal(r.Cells["SoTinChi"].Value); } }
